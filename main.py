...
For each image, return succinct notes on these dimensions: number of pigs, environment pigs are in, positive behaviors, negative behaviors, health issues, and posture. Below are examples of each of those dimensions. Only turn concise labels on what you do observe in the image for each dimension.
...
Posture: sitting position (like a dog sits), lying down with legs stretched out, lying down without legs stretched out, feeding, standing, in motion."""
